...
jQuery.extend(jQuery.support,{isTouchEnabled:function(){return!("ontouchstart"in window)&&!("ontouchend"in document)&&!window.navigator.msPointerEnabled?false:true}});function wijmoApplyWijTouchUtilEvents(a){if(!("ontouchstart"in window)&&!("ontouchend"in document)&&!window.navigator.msPointerEnabled||a.supportWijTouch)return a;a.supportWijTouch=true;var d,b,c={click:"wijtap",dblclick:"wijdoubletap",mouseenter:"wijmouseover",mouseover:"wijmouseover",mouseleave:"wijmouseout",mouseout:"wijmouseout",mousedown:"wijmousedown",mouseup:"wijmouseup",mousemove:"wijmousemove",mousecancel:"wijmousecancel",gesturestart:"wijgesturestart",gesturechange:"wijgesturechange",gestureend:"wijgestureend",swipeleft:"wijswipeleft",swiperight:"wijswiperight",swipe:"wijswipe"};d=function(a){return c[a.substr(1)]?" "+c[a.substr(1)]:a};b=function(a){if(typeof a==="string"){var g,f=0,e,b="";for(g in c){if(f===0)b+="(";else b+="|";b+="[\\s]+"+g;f+=1}b+=")";a=" "+a;e=new RegExp(b,"g");a=a.replace(e,d).substr(1)}return a};a=a.sub();a.fn.bind=function(){arguments[0]=b(arguments[0]);return jQuery.fn.bind.apply(this,arguments)};a.fn.unbind=function(){arguments[0]=b(arguments[0]);return jQuery.fn.unbind.apply(this,arguments)};a.fn.live=function(){arguments[0]=b(arguments[0]);return jQuery.fn.live.apply(this,arguments)};a.fn.die=function(){arguments[0]=b(arguments[0]);return jQuery.fn.die.apply(this,arguments)};a.fn.on=function(){arguments[0]=b(arguments[0]);return jQuery.fn.on.apply(this,arguments)};a.fn.off=function(){arguments[0]=b(arguments[0]);return jQuery.fn.off.apply(this,arguments)};return a}(function(a,N,v,K){var f="virtualMouseBindings",p="virtualTouchID",s="wijmouseover wijmousedown wijmousemove wijmouseup wijclick wijtap wijdoubletap wijtaphold wijmouseout wijmousecancel".split(" "),b=N.navigator.msPointerEnabled,u={wijmouseover:!b?"mouseover":"MSPointerOver",wijmousedown:!b?"mousedown":"MSPointerDown",wijmousemove:!b?"mousemove":"MSPointerMove",wijmouseup:!b?"mouseup":"MSPointerUp",wijmouseout:!b?"mouseout":"MSPointerOut",wijmousecancel:!b?"mousecancel":"mousecancel",wijclick:!b?"click":"MSGestureTap",wijdoubletap:!b?"dblclick":"MSGestureDoubleTap",wijtaphold:!b?"gesturehold":"MSGestureHold"},F="clientX clientY pageX pageY screenX screenY".split(" "),C="clientX clientY pageX pageY screenX screenY".split(" "),V=a.event.mouseHooks?a.event.mouseHooks.props:[],U=a.event.props.concat(V),c={},k=0,L=0,M=0,e=false,m=[],r=false,i=false,q="addEventListener"in v,n=a(v),W=1,h=0,b=N.navigator.msPointerEnabled,g=!b?"touchstart":"MSPointerDown",I=!b?"touchend":"MSPointerUp",G=!b?"touchmove":"MSPointerMove",A=!b?"scroll":"scroll";a.wijmouse={moveDistanceThreshold:10,clickDistanceThreshold:10,resetTimerDuration:1500};function j(a){while(a&&typeof a.originalEvent!=="undefined")a=a.originalEvent;return a}function T(b,m){var e=b.type,i,f,h,c,g,k,l,d;b=a.Event(b);b.nativeType=b.type;b.type=m;i=b.originalEvent;f=a.event.props;if(e.search(/^(mouse|click)/)>-1)f=U;if(i)for(l=f.length,c;l;){c=f[--l];b[c]=i[c]}if(e.search(/mouse(down|up)|click/)>-1&&!b.which)b.which=1;h=j(i);for(d=0,len=C.length;d<len;d++){c=C[d];if(b[c]===K)b[c]=h[c]}if(e.search(/^touch/)!==-1){e=h.touches;g=h.changedTouches;k=e&&e.length?e[0]:g&&g.length?g[0]:K;if(k)for(d=0,len=F.length;d<len;d++){c=F[d];b[c]=k[c]}}return b}function l(b){var c={},d,e;while(b){d=a.data(b,f);for(e in d)if(d[e])c[e]=c.hasVirtualBinding=true;b=b.parentNode}return c}function O(b,d){var c;while(b){c=a.data(b,f);if(c&&(!d||c[d]))return b;b=b.parentNode}return null}function S(){i=false}function w(){i=true}function R(){h=0;m.length=0;r=false;w()}function Q(){S()}function t(){D();k=setTimeout(function(){k=0;R()},a.wijmouse.resetTimerDuration)}function D(){if(k){clearTimeout(k);k=0}}function d(b,c,d){var e;if(d&&d[b]||!d&&O(c.target,b)){e=T(c,b);a(c.target).trigger(e)}return e}function y(b){var g=a.data(b.target,p),e,f;if(!r&&(!h||h!==g)){e="wij"+b.type;for(f in u)if(u[f]===b.type)e=f;var c=d(e,b);if(c){c.isDefaultPrevented()&&b.preventDefault();c.isPropagationStopped()&&b.stopPropagation();c.isImmediatePropagationStopped()&&b.stopImmediatePropagation()}}}function B(c){var k=j(c).touches,i,f,g;if(k&&k.length===1||b){i=c.target;f=l(i);if(f.hasVirtualBinding){h=W++;a.data(i,p,h);D();Q();e=false;g=j(c);var m=g.touches?g.touches[0]:g;L=m.pageX;M=m.pageY;d("wijmouseover",c,f);d("wijmousedown",c,f)}}}function J(a){if(i)return;!e&&d("wijmousecancel",a,l(a.target));e=true;t()}function E(b){if(i)return;var c=j(b),g=c.touches?c.touches[0]:c,h=e,f=a.wijmouse.moveDistanceThreshold;e=e||Math.abs(g.pageX-L)>f||Math.abs(g.pageY-M)>f,flags=l(b.target);e&&!h&&d("wijmousecancel",b,flags);d("wijmousemove",b,flags);t()}function H(a){if(i)return;w();var c=l(a.target),b,f;d("wijmouseup",a,c);if(!e){var g=d("wijclick",a,c);if(g&&g.isDefaultPrevented()){b=j(a);f=b.changedTouches?b.changedTouches[0]:b;m.push({touchID:h,x:f.clientX,y:f.clientY});r=true}}d("wijmouseout",a,c);e=false;t()}function x(d){var b=a.data(d,f),c;if(b)for(c in b)if(b[c])return true;return false}function z(){}function P(b){var d=u[b];return{setup:function(){!x(this)&&a.data(this,f,{});var e=a.data(this,f);e[b]=true;c[b]=(c[b]||0)+1;c[b]===1&&n.bind(d,y);a(this).bind(d,z);if(q){c[g]=(c[g]||0)+1;c[g]===1&&n.bind(g,B).bind(I,H).bind(G,E).bind(A,J)}},teardown:function(){--c[b];!c[b]&&n.unbind(d,y);if(q){--c[g];!c[g]&&n.unbind(g,B).unbind(G,E).unbind(I,H).unbind(A,J)}var h=a(this),e=a.data(this,f);if(e)e[b]=false;h.unbind(d,z);!x(this)&&h.removeData(f)}}}for(var o=0;o<s.length;o++)a.event.special[s[o]]=P(s[o]);q&&v.addEventListener("click",function(c){var g=m.length,f=c.target,h,i,b,d,e,j;if(g){h=c.clientX;i=c.clientY;threshold=a.wijmouse.clickDistanceThreshold;b=f;while(b){for(d=0;d<g;d++){e=m[d];j=0;if(b===f&&Math.abs(e.x-h)<threshold&&Math.abs(e.y-i)<threshold||a.data(b,p)===e.touchID){c.preventDefault();c.stopPropagation();return}}b=b.parentNode}}},true)})(jQuery,window,document);(function(a,c,p){a.each("touchstart touchmove touchend orientationchange throttledresize wijtap wijtaphold wijswipe wijswipeleft wijswiperight wijscrollstart wijscrollstop".split(" "),function(c,b){a.fn[b]=function(a){return a?this.bind(b,a):this.trigger(b)};a.attrFn[b]=true});var b="ontouchend"in document,o="touchmove scroll",l=b?"touchstart":"mousedown",m=b?"touchend":"mouseup",g=b?"touchmove":"mousemove",j=b?"gesturestart":"gesturestart",h=b?"gesturechange":"gesturechange",k=b?"gestureend":"gestureend";if(c.navigator.msPointerEnabled){l="MSPointerDown";m="MSPointerUp";g="MSPointerMove";j="MSGestureStart";h="MSGestureChange";k="MSGestureEnd"}function f(e,d,b){var c=b.type;b.nativeType=b.type;b.type=d;a.event.handle.call(e,b);b.type=c}a.event.special.wijscrollstart={enabled:true,setup:function(){var c=this,g=a(c),b,e;function d(a,d){b=d;f(c,b?"wijscrollstart":"wijscrollstop",a)}g.bind(o,function(c){if(!a.event.special.wijscrollstart.enabled)return;!b&&d(c,true);clearTimeout(e);e=setTimeout(function(){d(c,false)},50)})}};a.event.special.wijtap={setup:function(){var b=this,c=a(b);c.bind("wijmousedown",function(d){if(d.which&&d.which!==1)return false;var i=d.target,k=d.originalEvent,j;function g(){clearTimeout(j)}function e(){g();c.unbind("wijclick",h).unbind("wijmouseup",g);a(document).unbind("wijmousecancel",e)}function h(a){e();i==a.target&&f(b,"wijtap",a)}c.bind("wijmouseup",g).bind("wijclick",h);a(document).bind("wijmousecancel",e);j=setTimeout(function(){f(b,"wijtaphold",a.Event("wijtaphold",{target:i}))},750)})}};a.event.special.wijswipe={scrollSupressionThreshold:10,durationThreshold:1e3,horizontalDistanceThreshold:30,verticalDistanceThreshold:75,setup:function(){var c=this,b=a(c);b.bind(l,function(e){var h=e.originalEvent.touches?e.originalEvent.touches[0]:e,c={time:+new Date,coords:[h.pageX,h.pageY],origin:a(e.target)},d;function f(b){if(!c)return;var e=b.originalEvent.touches?b.originalEvent.touches[0]:b;d={time:+new Date,coords:[e.pageX,e.pageY]};Math.abs(c.coords[0]-d.coords[0])>a.event.special.wijswipe.scrollSupressionThreshold&&b.preventDefault()}b.bind(g,f).one(m,function(){b.unbind(g,f);if(c&&d)d.time-c.time<a.event.special.wijswipe.durationThreshold&&Math.abs(c.coords[0]-d.coords[0])>a.event.special.wijswipe.horizontalDistanceThreshold&&Math.abs(c.coords[1]-d.coords[1])<a.event.special.wijswipe.verticalDistanceThreshold&&c.origin.trigger("wijswipe").trigger(c.coords[0]>d.coords[0]?"wijswipeleft":"wijswiperight");c=d=p})})}};var i="altKey ctrlKey metaKey rotation scale shiftKey target velocityX velocityY translationX translationY".split(" ");function d(a){if(c.navigator.msPointerEnabled&&!a.__wijMSGesturePreInit){a.__wijMSGesturePreInit=true;var b=new MSGesture;b.target=a;a.addEventListener("MSPointerDown",function(a){b.addPointer(a.pointerId)},false)}}function e(d,b){var c=n(b,d);a(b.target).trigger(c);return c}function n(b,k){var o=b.type,e,g,n,d,m,l,h,f,j;e=b.originalEvent;b=a.Event(b);b.nativeType=b.type;b.type=k;g=a.event.props;if(e)for(h=g.length,d;h;){d=g[--h];b[d]=b[d]||e[d]}for(f=0,j=i.length;f<j;f++){d=i[f];b[d]=b[d]||e[d]}if(c.navigator.msPointerEnabled&&b.rotation)b.rotation=b.rotation*360/Math.PI;return b}a.event.special.wijgesturestart={setup:function(){var b=this,c=a(b);d(b,"wijgesturestart");c.bind(j,function(a){e("wijgesturestart",a)})}};a.event.special.wijgesturechange={setup:function(){var b=this,c=a(b);d(b,"wijgesturechange");c.bind(h,function(a){e("wijgesturechange",a)})}};a.event.special.wijgestureend={setup:function(){var b=this,c=a(b);d(b,"wijgestureend");c.bind(k,function(a){e("wijgestureend",a)})}};(function(b,a){var h=b(a),m,c,f,d,e,g={"0":true,"180":true};if("orientation"in a&&"onorientationchange"in a){var k=a.innerWidth||b(a).width(),j=a.innerHeight||b(a).height(),l=50;d=k>j&&k-j>l;e=g[a.orientation];if(d&&e||!d&&!e)g={"-90":true,"90":true}}b.event.special.orientationchange=m={setup:function(){if("orientation"in a&&"onorientationchange"in a&&b.mobile.orientationChangeEnabled)return false;f=c();h.bind("throttledresize",i)},teardown:function(){if("orientation"in a&&"onorientationchange"in a&&b.mobile.orientationChangeEnabled)return false;h.unbind("throttledresize",i)},add:function(a){var b=a.handler;a.handler=function(a){a.orientation=c();return b.apply(this,arguments)}}};function i(){var a=c();if(a!==f){f=a;h.trigger("orientationchange")}}b.event.special.orientationchange.orientation=c=function(){var b=true,c=document.documentElement;if("orientation"in a&&"onorientationchange"in a)b=g[a.orientation];else b=c&&c.clientWidth/c.clientHeight<1.1;return b?"portrait":"landscape"}})(jQuery,c);(function(){a.event.special.throttledresize={setup:function(){a(this).bind("resize",c)},teardown:function(){a(this).unbind("resize",c)}};var g=250,c=function(){d=+new Date;e=d-f;if(e>=g){f=d;a(this).trigger("throttledresize")}else{b&&clearTimeout(b);b=setTimeout(c,g-e)}},f=0,b,d,e})();a.each({wijscrollstop:"wijscrollstart",wijtaphold:"wijtap",wijswipeleft:"wijswipe",wijswiperight:"wijswipe"},function(c,b){a.event.special[c]={setup:function(){a(this).bind(b,a.noop)}}})})(jQuery,this);
...
(function(a){"use strict";a.widget("wijmo.wijslider",a.ui.slider,{options:{buttonMouseOver:null,buttonMouseOut:null,buttonMouseDown:null,buttonMouseUp:null,buttonClick:null,dragFill:true,minRange:0},widgetEventPrefix:"wijslider",_setOption:function(d,c){var b=this;if(d==="values"){c=b._pre_set_values(c);b.options[d]=c;b._setValuesOption()}else a.ui.slider.prototype._setOption.apply(b,arguments);if(d==="disabled")b._handleDisabledOption(c,b.element.parent());else d==="range"&&b._setRangeOption(c);return this},_setRangeOption:function(d){var c=this,a=c.options,b;if(d===true){if(!a.values||a.values&&a.values.length===0){b=c._valueMin();a.values=[b,b]}else if(a.values.length&&a.values.length!==2){b=a.values[0];a.values=[b,b]}c._refresh_handle(2)}c._re_createRange();c._refreshValue()},_setValuesOption:function(){var b=this,d=0,c;b._animateOff=true;b._refreshValue();if(a.isArray(b.options.values))d=b.options.values.length;for(c=0;c<d;c++)b._change(null,c);b._animateOff=false},_re_createRange:function(){var b=this,c=b.options;b.range&&b.range.remove();if(c.range)b.range=a("<div></div>").appendTo(b.element).addClass("ui-slider-range ui-widget-header"+(c.range==="min"||c.range==="max"?" ui-slider-range-"+c.range:""))},_pre_set_values:function(a){var c=this,e=c.options,d=1,b;d=a&&a.length?a.length:1;if(e.range===true){if(!a||a&&a.length===0){b=c._valueMin();a=[b,b]}else if(a.length&&a.length!==2){b=a[0];a=[b,b]}d=2}c._refresh_handle(d);c._re_createRange();return a},_refresh_handle:function(b){var a=this,c=a.handles.length,f="<a class='ui-slider-handle ui-state-default ui-corner-all' href='#'></a>",e=[],d;if(c!==b){if(b>c){for(d=c;d<b;d++)e.push(f);a.element.append(e.join(""))}else a.element.find(".ui-slider-handle").eq(b-1).nextAll().remove();a.handles=a.element.find(".ui-slider-handle")}},_create:function(){var b=this,c=b.element,d=b.options,i,l,e,g,h,n,m,f,j,k,o;if(window.wijmoApplyWijTouchUtilEvents)a=window.wijmoApplyWijTouchUtilEvents(a);b._oriStyle=c.attr("style");if(c.is(":input")){if(d.orientation==="horizontal")i=a("<div></div>").width(c.width()).appendTo(document.body);else i=a("<div></div>").height(c.height()).appendTo(document.body);l=c.val();if(l!=="")try{e=l.split(";");h=e.length;if(h>0){for(g=0;g<h;g++)e[g]=parseInt(e[g],10);if(h===1)d.value=e[0];else d.values=e}}catch(q){}c.data(b.widgetName,i.wijslider(d)).after(a(document.body).children("div:last")).hide();if(d.disabledState){var p=d.disabled;b.disable();d.disabled=p}return}a.ui.slider.prototype._create.apply(b,arguments);c.data("originalStyle",c.attr("style"));c.data("originalContent",c.html());n=c.width();m=c.height();f=a("<div></div>");if(d.orientation==="horizontal")f.addClass("wijmo-wijslider-horizontal");else f.addClass("wijmo-wijslider-vertical");f.width(n).height(m);j=a('<a class="wijmo-wijslider-decbutton"><span></span></a>');k=a('<a class="wijmo-wijslider-incbutton"><span></span></a>');c.wrap(f).before(j).after(k);b._container=c.parent();b._attachClass();o=c.find(".ui-slider-handle");b._adjustSliderLayout(j,k,o);if(d.disabledState){var p=d.disabled;b.disable();d.disabled=p}b.element.is(":hidden")&&b.element.wijAddVisibilityObserver&&b.element.wijAddVisibilityObserver(function(){b._refresh();b.element.wijRemoveVisibilityObserver&&b.element.wijRemoveVisibilityObserver()},"wijslider");b._bindEvents()},_handleDisabledOption:function(b,c){var a=this;if(b){if(!a.disabledDiv)a.disabledDiv=a._createDisabledDiv(c);a.disabledDiv.appendTo("body")}else if(a.disabledDiv){a.disabledDiv.remove();a.disabledDiv=null}},_createDisabledDiv:function(d){var g=this,b=d?d:g.element,c=b.offset(),f=b.outerWidth(),e=b.outerHeight();return a("<div></div>").addClass("ui-disabled").css({"z-index":"99999",position:"absolute",width:f,height:e,left:c.left,top:c.top})},refresh:function(){var b=this.element.data("wijslider"),a=this.element.data("wijmoWijslider");this.destroy();this.element.data("wijslider",b);this.element.data("wijmoWijslider",a);this._create()},_refresh:function(){var a=this,c,b,d;b=a._container.find(".wijmo-wijslider-decbutton");c=a._container.find(".wijmo-wijslider-incbutton");d=a._container.find(".ui-slider-handle");a._adjustSliderLayout(b,c,d);a._refreshValue()},_adjustSliderLayout:function(e,f,q){var h=this,g=h.element,r=h.options,b,a,d,c,j,i,l,k,o,p,m,n;b=h._container.width();a=h._container.height();d=e.outerWidth();c=e.outerHeight();j=f.outerWidth();i=f.outerHeight();l=q.outerWidth();k=q.outerHeight();if(r.orientation==="horizontal"){o=a/2-c/2;e.css("top",o).css("left",0);p=a/2-i/2;f.css("top",p).css("right",0);g.css("left",d+l/2-1).css("top",a/2-g.outerHeight()/2).width(b-d-j-l-2)}else{m=b/2-d/2;e.css("left",m).css("top",0);n=b/2-j/2;f.css("left",n).css("bottom",0);g.css("left",b/2-g.outerWidth()/2).css("top",c+k/2+1).height(a-c-i-k-2)}},destroy:function(){var b=this,c,d;c=this._getDecreBtn();d=this._getIncreBtn();c.unbind("."+b.widgetName);d.unbind("."+b.widgetName);a.ui.slider.prototype.destroy.apply(this,arguments);a("a",b.element.parent()).remove();b.element.unbind("."+b.widgetName);b.element.unwrap();if(b._oriStyle===undefined)b.element.removeAttr("style");else b.element.attr("style",b._oriStyle);b.element.removeData(b.widgetName).removeData("originalStyle").removeData("originalContent");if(b.disabledDiv){b.disabledDiv.remove();b.disabledDiv=null}},_slide:function(i,f,e){var g=this,h=g.options,c=h.minRange,d=e,b;if(h.range===true){b=g.values();if(f===0&&b[1]-c<e)d=b[1]-c;else if(f===1&&b[0]+c>e)d=b[0]+c}a.ui.slider.prototype._slide.call(g,i,f,d)},_getDecreBtn:function(){return this.element.parent().find(".wijmo-wijslider-decbutton")},_getIncreBtn:function(){return this.element.parent().find(".wijmo-wijslider-incbutton")},_attachClass:function(){this._getDecreBtn().addClass("ui-corner-all ui-state-default").attr("role","button");this._getIncreBtn().addClass("ui-corner-all ui-state-default").attr("role","button");this.element.parent().attr("role","slider").attr("aria-valuemin",this.options.min).attr("aria-valuenow","0").attr("aria-valuemax",this.options.max);if(this.options.orientation==="horizontal"){this.element.parent().addClass("wijmo-wijslider-horizontal");this._getDecreBtn().find("> span").addClass("ui-icon ui-icon-triangle-1-w");this._getIncreBtn().find("> span").addClass("ui-icon ui-icon-triangle-1-e")}else{this.element.parent().addClass("wijmo-wijslider-vertical");this._getDecreBtn().find("> span").addClass("ui-icon ui-icon-triangle-1-n");this._getIncreBtn().find("> span").addClass("ui-icon ui-icon-triangle-1-s")}},_bindEvents:function(){var a=this,b,c,d;b=this._getDecreBtn();c=this._getIncreBtn();d=a.element;b.bind("click."+a.widgetName,a,a._decreBtnClick);c.bind("click."+a.widgetName,a,a._increBtnClick);b.bind("mouseover."+a.widgetName,a,a._decreBtnMouseOver);b.bind("mouseout."+a.widgetName,a,a._decreBtnMouseOut);b.bind("mousedown."+a.widgetName,a,a._decreBtnMouseDown);b.bind("mouseup."+a.widgetName,a,a._decreBtnMouseUp);c.bind("mouseover."+a.widgetName,a,a._increBtnMouseOver);c.bind("mouseout."+a.widgetName,a,a._increBtnMouseOut);c.bind("mousedown."+a.widgetName,a,a._increBtnMouseDown);c.bind("mouseup."+a.widgetName,a,a._increBtnMouseUp);d.bind("mouseup."+a.widgetName,a,a._elementMouseupEvent)},_decreBtnMouseOver:function(d){var a=d.data,c,b;if(a.options.disabledState||a.options.disabled)return;c={buttonType:"decreButton"};a._trigger("buttonMouseOver",d,c);b=a._getDecreBtn();b.addClass("ui-state-hover")},_increBtnMouseOver:function(d){var a=d.data,c,b;if(a.options.disabledState||a.options.disabled)return;c={buttonType:"increButton"};a._trigger("buttonMouseOver",d,c);b=a._getIncreBtn();b.addClass("ui-state-hover")},_decreBtnMouseOut:function(d){var a=d.data,c,b;if(a.options.disabledState||a.options.disabled)return;c={buttonType:"decreButton"};a._trigger("buttonMouseOut",d,c);b=a._getDecreBtn();b.removeClass("ui-state-hover ui-state-active")},_increBtnMouseOut:function(d){var a=d.data,c,b;if(a.options.disabledState||a.options.disabled)return;c={buttonType:"increButton"};a._trigger("buttonMouseOut",d,c);b=a._getIncreBtn();b.removeClass("ui-state-hover ui-state-active")},_decreBtnMouseDown:function(e){var b=e.data,d,c;if(b.options.disabledState||b.options.disabled)return;d={buttonType:"decreButton"};b._trigger("buttonMouseDown",e,d);c=b._getDecreBtn();c.addClass("ui-state-active");a(document).bind("mouseup."+b.widgetName,{self:b,ele:c},b._documentMouseUp);if(b._intervalID!==null){window.clearInterval(b._intervalID);b._intervalID=null}b._intervalID=window.setInterval(function(){b._decreBtnHandle(b)},200)},_documentMouseUp:function(c){var b=c.data.self,d=c.data.ele;if(b.options.disabledState||b.options.disabled)return;d.removeClass("ui-state-active");if(b._intervalID!==null){window.clearInterval(b._intervalID);b._intervalID=null}a(document).unbind("mouseup."+b.widgetName,b._documentMouseUp)},_intervalID:null,_increBtnMouseDown:function(e){var b=e.data,d,c;if(b.options.disabledState||b.options.disabled)return;d={buttonType:"increButton"};b._trigger("buttonMouseDown",e,d);c=b._getIncreBtn();c.addClass("ui-state-active");a(document).bind("mouseup."+b.widgetName,{self:b,ele:c},b._documentMouseUp);if(b._intervalID!==null){window.clearInterval(b._intervalID);b._intervalID=null}b._intervalID=window.setInterval(function(){b._increBtnHandle(b)},200)},_decreBtnMouseUp:function(d){var a=d.data,c,b;if(a.options.disabledState||a.options.disabled)return;c={buttonType:"decreButton"};a._trigger("buttonMouseUp",d,c);b=a._getDecreBtn();b.removeClass("ui-state-active");window.clearInterval(a._intervalID)},_increBtnMouseUp:function(d){var a=d.data,c,b;if(a.options.disabledState||a.options.disabled)return;c={buttonType:"increButton"};a._trigger("buttonMouseUp",d,c);b=a._getIncreBtn();b.removeClass("ui-state-active");window.clearInterval(a._intervalID)},_decreBtnHandle:function(a){if(a.options.orientation==="horizontal")a._decre();else a._incre()},_decreBtnClick:function(c){var a=c.data,b;if(a.options.disabledState||a.options.disabled)return;a._mouseSliding=false;a._decreBtnHandle(a);b={buttonType:"decreButton",value:a.value()};a._trigger("buttonClick",c,b)},_increBtnHandle:function(a){if(a.options.orientation==="horizontal")a._incre();else a._decre()},_increBtnClick:function(c){var a=c.data,b;if(a.options.disabledState||a.options.disabled)return;a._mouseSliding=false;a._increBtnHandle(a);b={buttonType:"increButton",value:a.value()};a._trigger("buttonClick",c,b)},_decre:function(){var a=this,b=a.value(),d=a.options,c=d.min,e=d.step;if(d.values&&d.values.length){b=a.values(0);if(b<=c)a.values(0,c);else a.values(0,b-e)}else{b=a.value();if(b<=c)a.value(c);else a.value(b-e)}a.element.parent().attr("aria-valuenow",a.value())},_incre:function(){var a=this,b=a.value(),c=a.options,e=c.max,f=c.step,d;if(c.values&&c.values.length){d=c.values.length===1?0:1;b=a.values(d);if(b>=e)a.values(d,e);else a.values(d,b+f)}else{b=a.value();if(b>=e)a.value(e);else a.value(b+f)}a.element.parent().attr("aria-valuenow",a.value())},_elementMouseupEvent:function(c){var b=c.data;if(b.options.dragFill&&b.options.range)if(b._dragFillStart>0)b._dragFillStart=0;else a.ui.slider.prototype._mouseCapture.apply(b,arguments)},_mouseCapture:function(b){this.element.parent().attr("aria-valuenow",this.value());if(this.options.dragFill)if(b.target.className==="ui-slider-range ui-widget-header"){this.elementSize={width:this.element.outerWidth(),height:this.element.outerHeight()};this.elementOffset=this.element.offset();return true}else try{return a.ui.slider.prototype._mouseCapture.apply(this,arguments)}catch(c){}else try{return a.ui.slider.prototype._mouseCapture.apply(this,arguments)}catch(c){}},_dragFillTarget:false,_dragFillStart:0,_rangeValue:0,_oldValue1:0,_oldValue2:0,_oldX:0,_oldY:0,_mouseStart:function(a){if(this.options.dragFill){if(a.target)if(a.target.className==="ui-slider-range ui-widget-header"){this._dragFillTarget=true;this._rangeValue=this.values(1)-this.values(0);this._oldValue1=this.values(0);this._oldValue2=this.values(1);this._oldX=a.pageX;this._oldY=a.pageY;return true}this._dragFillTarget=false}return true},_mouseDrag:function(f){var d,c,e,b,g,h;if(this.options.dragFill){d=f.pageX-this._oldX;c=this.element.outerWidth();if(this.options.orientation==="vertical"){c=this.element.outerHeight();d=-(f.pageY-this._oldY)}e=(this.options.max-this.options.min)/c*d;if(this._dragFillTarget){if(this.options.orientation==="vertical")a(document.documentElement).css("cursor","s-resize");else a(document.documentElement).css("cursor","w-resize");if(this._dragFillStart>0){b=this._rangeValue;this.values(0,this._oldValue1+e);this.values(1,this._oldValue1+e+b);g=this.values(0);h=this.values(1);g+b>this.options.max&&this.values(0,this.options.max-b);h-b<this.options.min&&this.values(1,this.options.min+b)}this._dragFillStart++;return false}else return a.ui.slider.prototype._mouseDrag.apply(this,arguments)}else return a.ui.slider.prototype._mouseDrag.apply(this,arguments)},_mouseStop:function(){var b=a.ui.slider.prototype._mouseStop.apply(this,arguments);if(this.options.dragFill){a(document.documentElement).css("cursor","default");window.setTimeout(function(){this._dragFillTarget=false;this._dragFillStart=0},500)}return b}})})(jQuery);
